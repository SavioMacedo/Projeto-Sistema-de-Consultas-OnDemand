...
namespace Persistencia
{
    ...
    public partial class Modelo : DbContext
    {
        ...
        private void ConsultaMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Entidade.Consulta>().Property<long>(x => x.ID).IsRequired().ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity<Entidade.Consulta>().HasKey(x => x.ID);
        }
        ...
        private void Tipo_ParametroMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Entidade.Tipo_Parametro>().Property<long>(x => x.PARAMETRO_CONSULTAID).HasColumnName(@"PARAMETRO_CONSULTAID").ValueGeneratedNever();
        ...
        #region PARAMETRO_CONSULTA Navigation properties
            ...
            modelBuilder.Entity<Entidade.PARAMETRO_CONSULTA>().HasMany(x => x.Tipo_Parametros).WithOne(op => op.PARAMETRO_CONSULTA).IsRequired(true).HasForeignKey(@"PARAMETRO_CONSULTAID");

        #endregion

        #region Tipo_Parametro Navigation properties

            modelBuilder.Entity<Entidade.Tipo_Parametro>().HasOne(x => x.PARAMETRO_CONSULTA).WithMany(op => op.Tipo_Parametros).IsRequired(true).HasForeignKey(@"PARAMETRO_CONSULTAID");
